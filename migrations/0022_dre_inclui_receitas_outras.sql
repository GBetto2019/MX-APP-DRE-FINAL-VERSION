-- ================================================================
-- 0022_dre_inclui_receitas_outras.sql
-- Inclui receitas_outras na receita_bruta do DRE.
-- Antes: receita_bruta = apenas comissoes
-- Agora: receita_bruta = comissoes + receitas_outras
-- ================================================================
...
BEGIN
  ...
  receita AS (
    SELECT
      (SELECT total FROM comissoes_periodo) +
      (SELECT total FROM receitas_outras_periodo) AS total
  ),
  estornos_periodo AS (
